...
const fetcher = (url: any) => fetch(url).then((data) => data.json());
...
const Searthbox = () => {
  ...
  const { data, error } = useSWR(
    `https://api.themoviedb.org/3/discover/movie?api_key=78eb03987f34d05d918381d81d8257fe&language=ja&page=${pageIndex}`,
    fetcher
  );
  console.log(data);

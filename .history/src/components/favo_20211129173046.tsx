...
const Favo = () => {
  ...
  const [favodata, setFavodata] = useState<any>(data);
  console.log(favodata);

  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/movie/${favodata[0].movieId}?api_key=78eb03987f34d05d918381d81d8257fe&language=ja`
    )
      .then((response) => {
        setFavodata(data.favos);

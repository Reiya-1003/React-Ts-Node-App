...
const Favo = () => {
  ...
  const duplicate = data.favos.filter(function (dabu: any, i: any, array: any) {
    console.log(array.indexOf(dabu.movienumber), i);
    return array.indexOf(dabu.movienumber) === i;
  });

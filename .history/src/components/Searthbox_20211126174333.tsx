...
const Searthbox = ({ pageContext }: any) => {
  ...
  useEffect(() => {
    fetch(
      "https://api.themoviedb.org/3/movie/580489?api_key=78eb03987f34d05d918381d81d8257fe&language=en-US"
    )
      .then((response) => {
  ...
  const handleChangePage = (
    ...
    fetch(
      ...
      .then((data) => {
        ...
        Movie.shift(); //pushとsetState両方使って見る
      ...
      <div className="container">
        <div className="row">
          <section className="col s4 offset-s4">
            ...
            {movies.length === 0 ? (
              <p style={{ color: "white" }}>No Search Result</p>
            ) : (
              <p></p>
            )}
          </section>
